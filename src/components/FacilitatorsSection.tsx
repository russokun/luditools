...
import { NormalizedFacilitator } from '@/types';

interface FacilitatorsSectionProps {
  title: string;
  facilitators: NormalizedFacilitator[];
}
          ...
          {facilitators.map((facilitator) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {facilitator.socialLinks && facilitator.socialLinks.length > 0 && (
                  <div className="flex gap-4">
                    {facilitator.socialLinks.map((link, index) => (
                      <a
                        key={index}
                        href={link.url}
                        target="_blank"
                        ...
                        aria-label={`${link.platform} de ${facilitator.name}`}
                      >
                        {/* Platform Icons */}
